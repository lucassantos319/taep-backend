...
export class updateTablesProprieties1628393600741 implements MigrationInterface {
    name = 'updateTablesProprieties1628393600741'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `tags` CHANGE `title` `titulo` varchar(255) NOT NULL");
        ...
        await queryRunner.query("ALTER TABLE `notices` DROP COLUMN `description`");
        ...
        await queryRunner.query("ALTER TABLE `projects` DROP COLUMN `objective`");
        ...
        await queryRunner.query("ALTER TABLE `notices` ADD `titulo` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `notices` ADD `descricao` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `projects` ADD `titulo` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `projects` ADD `descricao` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `projects` ADD `objetivo` varchar(255) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `users_projetos_projects` ADD PRIMARY KEY (`usersId`, `usersEmail`, `projectsId`)");
        await queryRunner.query("ALTER TABLE `projects_avisos_notices` DROP COLUMN `created_at`");
        await queryRunner.query("ALTER TABLE `projects` DROP COLUMN `objetivo`");
        await queryRunner.query("ALTER TABLE `projects` DROP COLUMN `descricao`");
        await queryRunner.query("ALTER TABLE `projects` DROP COLUMN `titulo`");
        await queryRunner.query("ALTER TABLE `notices` DROP COLUMN `descricao`");
        await queryRunner.query("ALTER TABLE `notices` DROP COLUMN `titulo`");
        ...
        await queryRunner.query("ALTER TABLE `projects_avisos_notices` ADD `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)");
        await queryRunner.query("ALTER TABLE `projects` ADD `objective` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `projects` ADD `description` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `projects` ADD `title` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `notices` ADD `description` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `notices` ADD `title` varchar(255) NOT NULL");
        ...
        await queryRunner.query("ALTER TABLE `tags` CHANGE `titulo` `title` varchar(255) NOT NULL");
        await queryRunner.query("CREATE INDEX `IDX_d4db37310394c13743df4b8097` ON `users_projetos_projects` (`projectsId`)");
        await queryRunner.query("CREATE INDEX `IDX_c50fdd1f6925679a3e187b9d2c` ON `users_projetos_projects` (`usersId`, `usersEmail`)");
        await queryRunner.query("CREATE INDEX `IDX_3e919187cc1d287f881fc4f6e4` ON `projects_tags_tags` (`tagsId`)");
        await queryRunner.query("CREATE INDEX `IDX_0e16f99420fe5a6ae7022afa8b` ON `projects_tags_tags` (`projectsId`)");

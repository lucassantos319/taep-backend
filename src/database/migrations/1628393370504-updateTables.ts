...
export class updateTables1628393370504 implements MigrationInterface {
    name = 'updateTables1628393370504'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `questions` ADD `type` int NOT NULL");
